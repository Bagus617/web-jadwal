...
function formValidator(){
	...
	var SKS_MATKUL = document.getElementById('sks_matkul');
	...
	if(notEmpty(ID_MATKUL, "Masukkan ID Mata Kuliah")){
		if(isAlphanumeric(ID_MATKUL, "ID Mata Kuliah Masukkannya hanya Alphanumeric")){
			if(lengthRestriction(ID_MATKUL, 6,10)) {
				if(notEmpty(NAMA_MATKUL, "Masukkan Nama Mata Kuliah")){
					if(isAlphabet(NAMA_MATKUL, "Nama Mata Kuliah Masukkannya hanya Huruf")){
						if(lengthRestriction(NAMA_MATKUL, 3,30)){
							if(notEmpty(SKS_MATKUL, "Masukkan SKS MATA KULIAH")){
								if(isNumeric(SKS_MATKUL, "SKS Mata Kuliah Masukkannya hanya Numeric")){
									if(lengthRestriction(SKS_MATKUL, 1,1)){
										if(notEmpty(SEMESTER, "Masukkan Semester")){
											if(isNumeric(SEMESTER, "SKS Mata Kuliah Masukkannya hanya Numeric")){
												if(lengthRestriction(SEMESTER, 1,1)){
												return true;
												}
											}
										}
