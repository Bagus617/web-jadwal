...
exit;
} else { $query = "SELECT * FROM mata_kuliah";
	...
	<div class="shell">
		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Tabel Mata Kuliah</h2>
					</div>
					<!-- End Box Head -->	
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
							<tr align='center'>
								...
								<td width="200px"> <b> NAMA MATA KULIAH</b> </td>
								<td width="200px"> <b> SKS MATA KULIAH</b> </td>
								<td width="200px"> <b> SEMESTER</b> </td>
							</tr>
							<?php
