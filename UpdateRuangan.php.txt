...
$query = "SELECT * FROM ruangan where ID_RUANGAN='$ID_RUANGAN'"; //get the data that will be updated
		   ...
		   <!-- Content -->
			<div id="content">
				...
				<div class="box-head">
					...
					<!-- End Box Head -->
					<br><br>
					<form name='Update' method = 'post' action='UpdateTabelRuangan.php'>
						...
						<div class="form">
							...
							<tr>
										...
										<td><input name="NAMA_RUANGAN" type="text" value="<?php echo $data['NAMA_RUANGAN']?>" class="field size1" ></td>
